...
int parseMetadata(parameter * & params, const int numparam, metadata & sim, cosmology & cosmo,
	#ifdef MG
	...
	icsettings & ic)
{
	...
	// parse MG parameters
	#ifdef MG
	if (!parseParameter(params, numparam, "mg background file", mg_cosmo.mg_bkg_file))
		strcpy(mg_cosmo.mg_bkg_file, "mg_bkg.csv");
